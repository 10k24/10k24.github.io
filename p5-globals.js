...
module.exports = {
  functions: [
    ...
    "background", "clear", "colorMode", "fill", "noFill", "noStroke", "stroke", "erase", "noErase",
    ...
    "beginContour", "beginShape", "bezierVertex", "curveVertex", "endContour", "endShape", "quadraticVertex", "vertex", "normal",
    "print", "cursor", "frameRate", "getTargetFrameRate", "noCursor", "windowResized", "fullscreen",
    "pixelDensity", "displayDensity", "getURL", "getURLPath", "getURLParams",
    "createCanvas", "resizeCanvas", "noCanvas", "createGraphics", "createFramebuffer",
    "blendMode", "noLoop", "loop", "isLooping", "push", "pop", "redraw", "p5",
    ...
    "select", "selectAll", "removeElements", "changed", "input",
    "createDiv", "createP", "createSpan", "createImg", "createA",
    "createSlider", "createButton", "createCheckbox", "createSelect", "createRadio",
    "createColorPicker", "createInput", "createFileInput",
    "createVideo", "createAudio", "createCapture", "createElement",
    "setMoveThreshold", "setShakeThreshold", "deviceMoved", "deviceTurned", "deviceShaken",
    ...
    "createImage", "saveCanvas", "saveFrames", "loadImage", "saveGif",
    "image", "tint", "noTint", "imageMode",
    ...
    "abs", "ceil", "constrain", "dist", "exp", "floor", "lerp", "log", "mag", "map", "max", "min", "norm", "pow", "round", "sq", "sqrt", "fract",
    "createVector",
    "noise", "noiseDetail", "noiseSeed", "randomSeed", "random", "randomGaussian",
    ...
    "ambientLight", "specularColor", "directionalLight", "pointLight", "lights", "lightFalloff", "spotLight", "noLights",
    "loadModel", "model",
    "loadShader", "createShader", "shader", "resetShader",
    "texture", "textureMode", "textureWrap",
    "normalMaterial", "ambientMaterial", "emissiveMaterial", "specularMaterial", "shininess",
    "camera", "perspective", "ortho", "frustum", "createCamera", "setCamera",
    "vertexNormal", "setAttributes",
    "getAudioContext", "userStartAudio", "getOutputVolume", "outputVolume", "sampleRate",
    "freqToMidi", "midiToFreq", "soundFormats", "saveSound", "loadSound", "createConvolver", "setBPM",
  ],
  constants: [
    "VERSION", "P2D", "WEBGL", "WEBGL2",
    "ARROW", "CROSS", "HAND", "MOVE", "TEXT", "WAIT",
    "HALF_PI", "PI", "QUARTER_PI", "TAU", "TWO_PI",
    "DEGREES", "RADIANS",
    "CORNER", "CORNERS", "RADIUS",
    "RIGHT", "LEFT", "CENTER", "TOP", "BOTTOM", "BASELINE",
    ...
    "RGB", "HSB", "HSL",
    "AUTO", "ALT", "BACKSPACE", "CONTROL", "DELETE",
    "DOWN_ARROW", "ENTER", "ESCAPE", "LEFT_ARROW", "OPTION",
    ...
    "STROKE", "FILL", "TEXTURE", "IMMEDIATE", "IMAGE",
    "NEAREST", "REPEAT", "CLAMP", "MIRROR",
    "LANDSCAPE", "PORTRAIT",
    "GRID", "AXES", "LABEL", "FALLBACK",
    "CONTAIN", "COVER",
    "UNSIGNED_BYTE", "UNSIGNED_INT", "FLOAT", "HALF_FLOAT", "RGBA",
    "frameCount", "deltaTime", "focused", "webglVersion",
